...
extern int  sgmmode;                  /* Super Game Module Mode             */
extern int  ntscFilter;               /* Blarggs SMS NTSC filter            */
...
#if defined(IDEHD)
extern char *HardDiskFile[2];
#endif
extern int  RAMPages;                 /* Number of 64K expansion RAM pages  */
extern byte *RAM;                     /* Main and expansion RAM             */
